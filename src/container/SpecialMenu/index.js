...
const SpecialMenu = () => (
  <div className="app__specialMenu flex__center padding__section">
    <div className="app__specialMenu-title">
      <SubHeading title="Menu that fits you palatte" />
      <h1 className="headtext__cormorant">Todays's Special</h1>
    </div>
    <div className="app__specialMenu-menu">
      <div className="app__specialMenu-menu_wine flex__center padding__section">
      ...
      <div className="app__specialMenu-menu_cocktail flex__center padding__section">
        <div className="app__specialMenu-menu_items">
